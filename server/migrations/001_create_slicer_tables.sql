...
-- Расширение uuid-ossp НЕ подключаем (убрано 2026-08-14).
--
-- Оно здесь не использовалось ни разу: все идентификаторы генерируются
-- встроенной gen_random_uuid(), доступной в PostgreSQL начиная с 13-й версии.
-- А вот вреда строка приносила реальный: на типовой минимальной установке
-- PostgreSQL без пакета contrib она падает с «could not open extension control
-- file», и ON_ERROR_STOP=1 обрывал самую первую миграцию на одиннадцатой
-- строке — до создания хотя бы одной таблицы.
